...
const Choose = () => {
  return (
    <div className="py-8 lg:py-16 px-8 sm:px-16 lg:px-30 grid gap-y-5 lg:gap-y-10 bg-lightGray">
      <div className="grid gap-2">
        {choosecontent.head.title}
        <div className="flex justify-center">
          <p className="max-w-[640px] text-center text-gray text-base font-medium">
